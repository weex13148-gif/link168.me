  ...
  return (
    <div className="min-h-dvh overflow-x-hidden bg-[#FFFEF8] text-[#113A1D]">
      ...
      <main className="mx-auto w-full max-w-3xl px-4 py-10 sm:px-6">
        ...
        <section className="mt-8 rounded-[26px] border border-[#DDE8CF] bg-[var(--ui-surface-strong)] p-5 sm:p-7">
        ...
        <form onSubmit={onSubmit} className="mt-6 rounded-[26px] border border-[#DDE8CF] bg-[var(--ui-surface-strong)] p-5 sm:p-7">
          ...
          <div className="mt-6 flex flex-col gap-3 sm:flex-row">
            ...
            <Link
              ...
              className="link168-button-press inline-flex min-h-12 items-center justify-center gap-2 rounded-full border border-[#DDE8CF] bg-[var(--ui-surface-strong)] px-6 text-sm font-black text-[#113A1D] transition hover:-translate-y-0.5"
            >
              返回账号安全
