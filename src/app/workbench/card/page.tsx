        ...
        <div className="grid gap-4 content-start">
          <div className="rounded-[28px] border border-[#E8DCCB] bg-white p-5 shadow-sm sm:p-6">
            ...
            <div className="mt-4 rounded-3xl bg-gradient-to-br from-[#DDE8CD] via-[#F7F1E7] to-[#EAF3FF] p-5">
              ...
              <div className="mt-4 flex flex-wrap items-center gap-2"><Link href={publicUrl} target="_blank" rel="noopener noreferrer" className="link168-button-press inline-flex min-h-10 items-center gap-2 rounded-full bg-[#2B241E] px-4 text-xs font-black text-white"><Share2 aria-hidden className="size-4" /> 查看公开页</Link><Link href="/dashboard" className="link168-button-press inline-flex min-h-10 items-center gap-2 rounded-full bg-white px-4 text-xs font-black text-[#3F5F31] ring-1 ring-[#E8DCCB]"><Palette aria-hidden className="size-4" /> 编辑主题</Link></div>
            </div>
          </div>
