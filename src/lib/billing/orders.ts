...
const ALLOWED_TRANSITIONS: Record<string, OrderStatus[]> = {
  ...
  [ORDER_STATUS.PAID]: [ORDER_STATUS.REFUND_PROCESSING, ORDER_STATUS.CLOSED],
  [ORDER_STATUS.FAILED]: [ORDER_STATUS.CANCELLED, ORDER_STATUS.CLOSED],
  [ORDER_STATUS.CANCELLED]: [],
  [ORDER_STATUS.EXPIRED]: [],
  [ORDER_STATUS.REFUND_PROCESSING]: [ORDER_STATUS.REFUNDED, ORDER_STATUS.PARTIALLY_REFUNDED, ORDER_STATUS.REFUND_FAILED, ORDER_STATUS.PAID],
  [ORDER_STATUS.PARTIALLY_REFUNDED]: [ORDER_STATUS.REFUND_PROCESSING, ORDER_STATUS.CLOSED],
  [ORDER_STATUS.REFUND_FAILED]: [ORDER_STATUS.REFUND_PROCESSING, ORDER_STATUS.CLOSED],
