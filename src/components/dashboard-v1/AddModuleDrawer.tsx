                  ...
                  {modules.map((mod) => {
                    ...
                    return (
                      <button
                        ...
                        className="group relative flex min-h-[88px] flex-col items-start justify-start gap-1.5 overflow-hidden rounded-xl border border-[var(--ui-line)] bg-white p-3 text-left transition-colors hover:border-[var(--ui-brand)] hover:bg-[var(--ui-brand-soft)] sm:min-h-[100px] sm:p-4 sm:items-center sm:text-center"
                      >
                        {isLocked && (
