      ...
      {!publicUrl ? (
        ...
        <div className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_360px]">
          <section className="ui-surface p-5 sm:p-6">
            ...
            <div className="mt-8 border-t border-[var(--ui-line)] pt-6">
              ...
              <div className="mt-4 grid gap-3 sm:grid-cols-2">
                <div className="rounded-xl border border-[var(--ui-line)] bg-white p-4"><p className="text-sm font-black">社交媒体简介</p><p className="mt-2 text-xs leading-5 ui-muted">将主页地址放进抖音、小红书、公众号或个人资料。</p></div>
                <div className="rounded-xl border border-[var(--ui-line)] bg-white p-4"><p className="text-sm font-black">线下物料</p><p className="mt-2 text-xs leading-5 ui-muted">下载二维码，用于名片、展架、海报或门店桌牌。</p></div>
              </div>
            </div>
          </section>
          ...
          <section className="ui-surface p-5 text-center sm:p-6">
            ...
            <div className="mx-auto mt-5 w-fit rounded-[18px] border border-[var(--ui-line)] bg-white p-3 shadow-[var(--ui-shadow-sm)]">
