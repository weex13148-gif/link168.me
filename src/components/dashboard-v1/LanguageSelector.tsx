  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex min-h-9 items-center gap-2 rounded-xl border border-[var(--ui-line)] bg-white px-3 text-xs font-black text-[var(--ui-muted)] transition hover:border-[var(--ui-brand)]/35"
