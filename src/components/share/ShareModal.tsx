    ...
    >
      ...
      >
        <div className="flex items-center justify-between gap-3">
          <div>
            <p className="text-sm font-black text-[#3F5F31]">分享</p>
            <h3 id="share-modal-title" className="mt-1 text-xl font-black text-[#2B241E]">
              {displayName}
            </h3>
          </div>
          <button
        ...
        <div className="mt-5 grid gap-3">
          ...
          >
            {copied ? (
            <>
              <CheckCircle className="size-5 text-[#6F8F4E]" aria-hidden="true" />
              <span className="text-[#6F8F4E]">已复制链接</span>
            </>
          ) : (
            <>
              <Copy className="size-5 text-[#7A6D5E]" aria-hidden="true" />
              复制链接
            </>
          )}
          </button>
          ...
          <button
            ...
            className="link168-button-press inline-flex min-h-12 w-full items-center justify-center gap-2 rounded-2xl border border-[#E8DCCB] bg-white text-sm font-black text-[#2B241E] hover:bg-[#F8F4EF] transition-colors focus:outline-none focus:ring-2 focus:ring-[#6F8F4E] focus:ring-offset-2"
          >
            <QrCode className="size-5 text-[#7A6D5E]" aria-hidden="true" />
            二维码名片
          </button>
        </div>

        <div className="mt-5 rounded-2xl border border-[#E8DCCB] bg-[#F8F4EF] p-3">
